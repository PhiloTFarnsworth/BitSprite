...
It's a little small.  The transparent background also does no favors for visibility with this basic gray scale.
...
Now we have a symmetrical image, and also one that allows your imagination to wander a little bit. 
...
quantity has a quality all its own.  Beyond the fact that it has potential for small sprites, icons, etc. there
